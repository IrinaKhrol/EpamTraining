...
{
    internal class Airplane : FlyingObject, IFlyable
    {
        const int MinSpeedKm = 200;
        const int MaxSpeedKm = 5000;
        const int SpeedIncrease = 10; // step of increasing speed for each section of the path flown
        const int SpeedPath = 10;  // the distance during which an airplane increases its speed
        const int MaxDistance = 2000;// maximum possible flight distance of an aircraft in 1 flight
